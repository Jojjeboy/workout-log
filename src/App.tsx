...
import { GeneratedExercisesProvider } from './contexts/GeneratedExercisesContext'; // Import the provider
...
function App() {
  ...
  return (
    <GeneratedExercisesProvider> {/* Wrap the entire AppShell with the provider */}
      <AppShell
